...
@section('con')
    <form action="{{url('/admin/orderlist')}}" method="get">
        <div class="col-lg-12">
                                    ...
                                    <table align="middle" id="dataTables-example"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="dataTables-example"
                                                ...
                                                aria-label="CSS grade: activate to sort column ascending">联系商家
                                            </th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        @foreach($data as $k=>$v)
                                            <tr class="gradeA even aaa" role="row">
                                                ...
                                                <td><h4><span class="label label-success accept"
                                                              style="cursor:pointer;">{{$v->shopname}}</span></h4></td>
                                            </tr>
                                        @endforeach
