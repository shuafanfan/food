...
@section('order')
    ...
    <form action="{{url('/home-person/order4')}}" method="get">
        <div class="col-lg-12">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('.label-success').click(function () {
                ...
                window.location.href = "{{url('/admin2/orderarrive')}}?n=" + ordernum;
                $(this).hide();
            });
            ...
            $('.label-warning').click(function () {
                ...
                var ordernum = $(this).parents('.aaa').find('.sorting_1').text();
                window.location.href = "{{url('/admin2/ordercancel')}}?n=" + ordernum;
                $(this).hide();
            });
        });
